...
var project_add = function (name, status, description, authUserId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, db_1.default.query('INSERT INTO `project`(name, description, status, added_by, added_time) VALUES (?, ?, ?, ?, ?)', [name, description, status, authUserId, currentDateTime])];
            case 1:
                result = _a.sent();
                if (result.status) {
...
var project_edit = function (name, status, description, authUserId, id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                currentDateTime = luxon_1.DateTime.now().setZone("Asia/Colombo").toFormat("y-MM-dd HH:mm:ss");
                return [4 /*yield*/, db_1.default.query('UPDATE `project` SET name = ?, description = ?, status = ?, updated_by = ?, updated_time = ? WHERE id = ? ', [name, description, status, authUserId, currentDateTime, id])];
            case 1:
                result = _a.sent();
                if (result.status) {
                    return [2 /*return*/, DefaultResponse_1.default.successFormat("200")];
...
var project_list = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var project_view = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var project_active_list = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var project_status_change = function (status, authUserId, id) { return __awaiter(void 0, void 0, void 0, function () {
    var currentDateTime, result, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                currentDateTime = luxon_1.DateTime.now().setZone("Asia/Colombo").toFormat("y-MM-dd HH:mm:ss");
                return [4 /*yield*/, db_1.default.query('UPDATE `project` SET status = ?, updated_by = ?, updated_time = ? WHERE id = ? ', [status, authUserId, currentDateTime, id])];
            case 1:
                result = _a.sent();
                if (result.status) {
                    return [2 /*return*/, DefaultResponse_1.default.successFormat("200")];
