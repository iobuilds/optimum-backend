...
var contactService = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var emailBody, sendMail, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                emailBody = emailTemplates_1.default.contactFormEmail(data.name, // Name
                data.email, // Email
                data.phone, // Phone
            ...
            case 1:
                sendMail = _a.sent();
                if (!sendMail) {
                    return [2 /*return*/, DefaultResponse_1.default.errorFormat("000", "Couldn't send email")];
                }
                return [2 /*return*/, DefaultResponse_1.default.successFormat("200", "Contact form submitted successfully")];
            case 2:
                err_1 = _a.sent();
