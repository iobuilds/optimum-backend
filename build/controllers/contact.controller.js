...
var contact_validate_1 = __importDefault(require("../validate/contact.validate"));
...
var createContact = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, (0, validate_1.default)(req.body, contact_validate_1.default.contact_add)];
            case 1:
                data = _a.sent();
                console.log(data);
                if (!data.status) {
                ...
                return [4 /*yield*/, contact_service_1.default.contactService(data.data)];
            case 2:
                result = _a.sent();
